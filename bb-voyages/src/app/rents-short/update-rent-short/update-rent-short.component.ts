...
@Component({
  selector: 'app-update-rent-short',
  templateUrl: './update-rent-short.component.html',
  styleUrls: ['./update-rent-short.component.css'],
})
export class UpdateRentShortComponent {
  ...
  constructor(
    ...
    this.api.getSingleRentShort(this.rentId).subscribe((rent: Rent) => {
      this.rent = rent;
  ...
  updateRentHandler(updateRentForm: NgForm) {
    ...
    this.api.updateShortRent(this.rentId, this.updatedRent).subscribe(() => {
